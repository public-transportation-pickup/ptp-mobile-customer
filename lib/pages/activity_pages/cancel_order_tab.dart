...
class CancelOrderTab extends StatefulWidget {
  @override
  _CancelOrderTabState createState() => _CancelOrderTabState();
}

class _CancelOrderTabState extends State<CancelOrderTab> {
  //CHECK LOG
              ...
              Expanded(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Hoàn tiền: ${formatPrice(order.returnAmount!)}'),
                    Text(formatDateToDate(order.creationDate)),
                  ],
                ),
              ),
              const Expanded(
